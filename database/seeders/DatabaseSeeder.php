...
class DatabaseSeeder extends Seeder {
   ...
   private static function seedCatalog() {
	//Borramos Contenido tabla Movies: CONTROLA EL SEED, porque si lo vuelvo a hacer , me crearia lo mismo Varias VECES (ERROR)
	Movie::truncate();
  ...
  // Movido de catalog/controller/CatalogController , ponerlo en static 
