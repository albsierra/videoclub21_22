                 ...
                 <form action="{{ url('/catalog/create') }}" method="POST">
                    {{method_field('PUT')}}
                     ...
                     <div class="form-group">
                        ...
                        <input type="number" name="year" value = "{{ $arrayPeliculas['year'] }}" id="year">
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <textarea name="synopsis" id="synopsis" class="form-control" rows="3">{{ $arrayPeliculas['synopsis'] }}</div>/textarea>
                     </div>
